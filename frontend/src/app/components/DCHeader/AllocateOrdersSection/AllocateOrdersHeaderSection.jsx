    ...
    return (
        <Stack direction='column'>
            ...
            <Stack direction='row' alignItems='center' justifyContent='space-between'>
                ...
                <Button variant="text"   sx={{textDecorationLine:'underline', fontSize:'13px', fontWeight:600, fontFamily:'inherit', color:'#DA291C'}}  onClick={props.toggleDrawer('right', true)}>Allocate</Button>
            </Stack>
        </Stack>
    );
};